package com.kostiago.backend.config;
...
import com.kostiago.backend.config.customgrant.CustomPasswordAuthenticationConverter;
import com.kostiago.backend.config.customgrant.CustomPasswordAuthenticationProvider;
import com.kostiago.backend.config.customgrant.CustomUserAuthorities;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(){
        RegisteredClient registeredClient = RegisteredClient
            .withId(UUID.randomUUID().toString()).clientId(clientId)
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer() {
        return context -> {
            ...
            List<String> permissions = user.getAuthorities().stream().map(x -> x.getAuthority()).toList();
